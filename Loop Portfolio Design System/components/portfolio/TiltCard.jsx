...
export function TiltCard({ children, max = 10, lift = 10, glare = true, style, ...rest }) {
  ...
  return (
    <div ref={ref} onMouseMove={move} onMouseLeave={() => setT({ rx: 0, ry: 0, mx: 50, my: 50, on: false })}
      style={{ perspective: 'var(--perspective)', ...style }} {...rest}>
      <div style={{
        ...
        {children}
        {glare && <span aria-hidden="true" style={{
          position: 'absolute', inset: 0, borderRadius: 'inherit', pointerEvents: 'none',
          opacity: t.on ? 0.35 : 0, transition: 'opacity var(--dur-base) var(--ease-out)',
